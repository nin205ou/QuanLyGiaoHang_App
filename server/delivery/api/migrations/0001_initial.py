# Generated by Django 5.0.3 on 2024-05-14 01:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expired_at', models.DateTimeField(default=datetime.datetime(2024, 5, 14, 1, 47, 57, 25887, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_time', models.DateTimeField(default=datetime.datetime(2024, 5, 14, 13, 32, 57, 26861, tzinfo=datetime.timezone.utc), verbose_name='end_time')),
                ('start_price', models.IntegerField(verbose_name='start_price')),
                ...
                ('winner_shipper', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='auctions_winner', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('us_collect', models.IntegerField(blank=True, null=True)),
                ('shipper_collect', models.IntegerField(blank=True, null=True)),
