...
INSERT INTO `api_user` (`id`, `password`, `last_login`, `is_superuser`, `username`, `first_name`, `last_name`, `email`, `is_active`, `date_joined`, `avatar`, `phone_number`, `cccd`, `address`, `is_staff`, `role_id`) VALUES (19, 'pbkdf2_sha256$720000$aaXb5BE4KoT9XXVKNEM5nK$ywLo8wXb46EEFK80Epfg+qgCzfx/H4aYNfKMpleOv08=', NULL, 0, 'thanh', '', 'thanhthanh', 'thanh@gmail.com', 1, '2024-05-07 03:28:51.038522', '', '0254564564', '12', 'quận 8', 0, 2);
